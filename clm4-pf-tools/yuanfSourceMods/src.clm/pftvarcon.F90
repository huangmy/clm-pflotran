...
!
  ...
  integer :: nshrub                 !value for last type of shrub
#ifdef PFTARCTIC
  integer :: nevr_arctic_shrub      !value for evergreen arctic shrub (FMYUAN, 2013 July)
  integer :: ndcd_arctic_shrub      !value for deciduous arctic shrub (FMYUAN, 2013 July)
  integer :: nc3_arctic_sedge       !value for C3 arctic sedge (FMYUAN, 2013 July)
  integer :: nc3_arctic_forb        !value for C3 arctic forb (FMYUAN, 2013 July)
  integer :: nc3_arctic_grass       !value for C3 arctic (true) grass (FMYUAN, 2013 July)
  integer :: nnonvas_arctic         !value for arctic non-vascular plant (FMYUAN, 2013 July)
  integer :: nlichen_arctic         !value for arctic lichen (FMYUAN, 2013 July)
#else
...
#ifdef PFTARCTIC
       if ( trim(pftname(i)) == 'evergreen_arctic_shrub'              ) nevr_arctic_shrub    = i
       if ( trim(pftname(i)) == 'deciduous_arctic_shrub'              ) ndcd_arctic_shrub    = i
       if ( trim(pftname(i)) == 'c3_arctic_sedge'                     ) nc3_arctic_sedge     = i
       if ( trim(pftname(i)) == 'c3_arctic_forb'                      ) nc3_arctic_forb      = i
       if ( trim(pftname(i)) == 'c3_arctic_grass'                     ) nc3_arctic_grass     = i
       if ( trim(pftname(i)) == 'nonvascular_arctic'                  ) nnonvas_arctic       = i
       if ( trim(pftname(i)) == 'lichen_arctic'                       ) nlichen_arctic       = i
#else
       if ( trim(pftname(i)) == 'c3_arctic_grass'                     ) nc3_arctic_grass     = i
#endif
...
#ifdef PFTARCTIC
    nshrub               = ndcd_arctic_shrub    ! value for last type of shrub
#else
