...
#ifdef PFTARCTIC
    use pftvarcon         , only : nevr_arctic_shrub,         ndcd_arctic_shrub,    &  ! (FMYUAN: 2013 July)
                                   nc3_arctic_sedge,          nc3_arctic_forb,      &
                                   nnonvas_arctic,            nlichen_arctic
#endif
...
#ifdef PFTARCTIC
          if (clmveg == nevr_arctic_shrub                   ) wesveg = 11   ! (FMYUAN: 2013 July)
          if (clmveg == ndcd_arctic_shrub                   ) wesveg = 11   ! (FMYUAN: 2013 July)
          if (clmveg == nc3_arctic_sedge                    ) wesveg = 3   ! (FMYUAN: 2013 July)
          if (clmveg == nc3_arctic_forb                     ) wesveg = 3   ! (FMYUAN: 2013 July)
          if (clmveg == nnonvas_arctic                      ) wesveg = 3   ! (FMYUAN: 2013 July)
          if (clmveg == nlichen_arctic                      ) wesveg = 8   ! (FMYUAN: 2013 July - like bare-soil?)
#endif
