...
contains
  ...
  subroutine SoilTemperature(bounds, num_urbanl, filter_urbanl, &
    ...
    real(r8) :: tk_snow(bounds%begc:bounds%endc)                          ! thermal conductivity of snow-h2osfc interface [W/(m K)] [col]
    real(r8) :: fn_snow(bounds%begc:bounds%endc)                          ! heat diffusion through snow-h2osfc interface [W/m2]
    !-----------------------------------------------------------------------
